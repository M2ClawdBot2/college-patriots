  ...
  return (
    <main>
      <header className="masthead">
        <Link className="brand" href="/" aria-label="The University Patriot home"><span className="seal">UP</span><span>THE UNIVERSITY<br/>PATRIOT</span></Link>
      ...
      <footer><div className="footer-brand"><span className="seal">UP</span><h2>THE UNIVERSITY<br/>PATRIOT</h2></div><p>Founded at the University of Florida. Independent student reporting from universities across the United States. Stories are attributed to the school—not the student.</p><div className="footer-links"><div><b>EXPLORE</b><a href="#dispatches">Dispatches</a><a href="#watch">Video</a><a href="#arcade">Arcade</a></div><div><b>FOLLOW</b><a href="#">X / Twitter</a><a href="#">YouTube</a><a href="#">Instagram</a></div></div><div className="copyright">© 2026 THE UNIVERSITY PATRIOT · GAINESVILLE, FL <span>THE CAMPUS RECORD, UNFILTERED.</span></div></footer>
    </main>
  );
}
